...
func PrepareAgentServicesYAML(_ context.Context, opts *options) (*supervisor.Supervisor, error) {
...
func PrepareClientServicesYAML(_ context.Context, opts *options) (*supervisor.Supervisor, *spire.Client, error) {
	err := config.ParseFile(&opts.Config, opts.ConfigFilePath)
	if err != nil {
...
func PrepareStreamServicesYAML(_ context.Context, opts *options) (*supervisor.Supervisor, transport.Transport, error) {
	err := config.ParseFile(&opts.Config, opts.ConfigFilePath)
	if err != nil {
		return nil, nil, fmt.Errorf(`config error: %w`, err)
	}
