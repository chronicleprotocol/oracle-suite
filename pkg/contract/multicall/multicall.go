...
var (
	...
	multicallAbi     = abi.MustParseSignatures(
		`function aggregate3((address target, bool allowFailure, bytes callData)[] calldata calls) public payable returns ((bool success, bytes returnData)[] memory returnData)`,
